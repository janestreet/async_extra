(* OASIS_START *)
(* DO NOT EDIT (digest: 9a0caf09d917ac9573bb900b8c24acbf) *)
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("async_extra", OCamlbuildDocPlugin.doc_build "lib")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("async_extra", OCamlbuildDocPlugin.doc_clean "lib")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "async_extra";
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "Jane street's async library (extra)";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "\165\134\255\213\1487\187Y\209\167tO\012I\012\028";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
